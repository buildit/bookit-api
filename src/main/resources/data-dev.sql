...
INSERT INTO BOOKABLE (BOOKABLE_ID, LOCATION_ID, BOOKABLE_NAME, DISPOSITION_CLOSED, DISPOSITION_REASON) VALUES
...
INSERT INTO BOOKABLE (BOOKABLE_ID, LOCATION_ID, BOOKABLE_NAME, DISPOSITION_CLOSED, DISPOSITION_REASON) VALUES
    ('0308b2aa-8aef-40d4-99af-d7cae8318523', '43ec3f7d-348d-427f-8c13-102ca0362a62', 'Dev Tower of London Spooky', '0',
     '');
INSERT INTO BOOKING (BOOKING_ID, BOOKABLE_ID, SUBJECT, START_DATE, END_DATE) VALUES
    ('e081f498-151b-49bf-a302-6cf248c991f3', 'cd87ee34-b393-4400-a1c9-d91278d4b8ee', 'My Booking',
     {fn TIMESTAMPADD(SQL_TSI_HOUR, -24, CURRENT_DATE)}, {fn TIMESTAMPADD(SQL_TSI_HOUR, -23, CURRENT_DATE)});
INSERT INTO BOOKING (BOOKING_ID, BOOKABLE_ID, SUBJECT, START_DATE, END_DATE) VALUES
    ('989fa334-7b8c-4dec-8be7-adf5e2302f39', 'cd87ee34-b393-4400-a1c9-d91278d4b8ee', 'Another Booking',
     {fn TIMESTAMPADD(SQL_TSI_HOUR, 1, CURRENT_DATE)}, {fn TIMESTAMPADD(SQL_TSI_HOUR, 2, CURRENT_DATE)});
INSERT INTO BOOKING (BOOKING_ID, BOOKABLE_ID, SUBJECT, START_DATE, END_DATE) VALUES
    ('c52c0fd4-9fdc-4d55-973c-2ba340c8edf6', 'bf16f7d9-d0ee-4333-86ff-5a97c75b4424', 'Plan All Things',
     {fn TIMESTAMPADD(SQL_TSI_HOUR, 3, CURRENT_DATE)}, {fn TIMESTAMPADD(SQL_TSI_HOUR, 4, CURRENT_DATE)});
INSERT INTO BOOKING (BOOKING_ID, BOOKABLE_ID, SUBJECT, START_DATE, END_DATE) VALUES
    ('9c73c6a9-b08d-416f-a401-d7c8a8279d13', 'bf16f7d9-d0ee-4333-86ff-5a97c75b4424', 'Execute Proletariat',
     {fn TIMESTAMPADD(SQL_TSI_HOUR, 7, CURRENT_DATE)}, {fn TIMESTAMPADD(SQL_TSI_HOUR, 8, CURRENT_DATE)});
INSERT INTO BOOKING (BOOKING_ID, BOOKABLE_ID, SUBJECT, START_DATE, END_DATE) VALUES
    ('2e46deec-a1d7-4842-a3e3-633032b50bf4', 'bfa745f7-cb86-493a-98b4-984173a9ab01', 'Wash Hands',
     {fn TIMESTAMPADD(SQL_TSI_HOUR, 24, CURRENT_DATE)}, {fn TIMESTAMPADD(SQL_TSI_HOUR, 25, CURRENT_DATE)});
